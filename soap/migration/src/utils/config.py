...
CLASSES_MIGRATION = MIGRATIONS_FOLDER_PATH+"/school_class"
PEOPLE_MIGRATION = MIGRATIONS_FOLDER_PATH+"/person"
PERSON_CLASS_MIGRATION = MIGRATIONS_FOLDER_PATH+"/person_school_class"
