...
pub async fn update_person(id:i32, person: NewPerson) -> Result<impl warp::Reply, warp::Rejection> {
...
pub async fn read_person_list() -> Result<impl warp::Reply, warp::Rejection> {
    ...
    Ok(warp::reply::json(&Person::from_read_list_response(res.person_list)))
}
